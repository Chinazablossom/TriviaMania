...
import com.example.triviamania.databinding.FragmentMathsLevelBinding
...
class MathsFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentMathsLevelBinding.inflate(inflater,container,false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            val easyadapter = StagesAdapter(requireContext(),easylist, R.id.mathGameFragment)
            val mediumadapter = StagesAdapter(requireContext(),mediumlist, R.id.mathGameFragment)
            val hardadapter = StagesAdapter(requireContext(),hardlist, R.id.mathGameFragment)
            val vhardadapter = StagesAdapter(requireContext(),vhardlist, R.id.mathGameFragment)
