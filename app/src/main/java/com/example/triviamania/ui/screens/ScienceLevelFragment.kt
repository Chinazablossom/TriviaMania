...
import com.example.triviamania.databinding.FragmentScienceLevelBinding
...
class ScienceLevelFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            ...
            val easyadapter = StagesAdapter(requireContext(),easylist, R.id.scienceGameFragment)
            val mediumadapter = StagesAdapter(requireContext(),mediumlist, R.id.scienceGameFragment)
            val hardadapter = StagesAdapter(requireContext(),hardlist, R.id.scienceGameFragment)
            val vhardadapter = StagesAdapter(requireContext(),vhardlist, R.id.scienceGameFragment)
